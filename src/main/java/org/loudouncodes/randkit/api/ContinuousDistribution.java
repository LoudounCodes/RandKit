 ...
 *
 * <p>Implementations are expected to be immutable and thread-confinement friendly. Any randomness
 * source (e.g., {@code java.util.random.RandomGenerator}) should be supplied to the
 * implementation's constructor; this interface focuses solely on the statistical surface.
 */
public interface ContinuousDistribution {
   ...
   *
   * <p>For {@code p} in the open interval (0, 1), returns a value {@code q} such that {@code cdf(q)
   * ≈ p}. For {@code p == 0} or {@code p == 1}, implementations may return {@link
   * Double#NEGATIVE_INFINITY} or {@link Double#POSITIVE_INFINITY}, respectively, where appropriate.
   *
