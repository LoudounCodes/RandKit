...
class UniformDoubleTest {
  ...
  void constructorValidation() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> new UniformDouble(Double.NEGATIVE_INFINITY, 1.0));
    assertThrows(
        IllegalArgumentException.class, () -> new UniformDouble(0.0, Double.POSITIVE_INFINITY));
  }
